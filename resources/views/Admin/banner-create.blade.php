                    ...
                    <div class="white_shd full margin_bottom_30">
                        ...
                        <div class="table_section padding_infor_info">
                            <div class="table-responsive-md">
                                <form method="post"
                                    action="{{ isset($data->banner_id) ? url('/admin/banners/' . $data->banner_id) : url('/admin/banners') }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="row ">
                                        <div class="col-md-6 p-2">
                                            <div class="form-group row">
                                                <label for="banner-name" class="col-sm-3 col-form-label">Banner Name
                                                </label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="col-md-6 p-2">
                                            <div class="form-group row">
                                                <label for="banner-header" class="col-sm-3 col-form-label">Banner Header
                                                </label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="banner_header"
                                                        value="{{ old('banner_header', $data->banner_header ?? '') }}"
                                                        class="form-control @error('banner_header') is-invalid @enderror"
                                                        id="banner-header" placeholder="Enter RBanner Header ">
                                                    @error('banner_header')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control @error('banner_image') is-invalid @enderror"
                                                        name="banner_image" type="file" id="banner-img">
                                                    <div class="form-text text-muted mt-1">
                                                        ✔ Required resolution: 577 × 432 pixels<br>
