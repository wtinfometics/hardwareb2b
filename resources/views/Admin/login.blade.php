                        ...
                        <form method="post" action="/login">
                            ...
                            <fieldset>
                                <div class="field">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" id="coupon-name"
                                ...
                                <div class="field">
                                    ...
                                    <input class="form-control @error('password') is-invalid @enderror" id="coupon-name"
                                        type="password" name="password" placeholder="Enter YThe Password" />
                                    @error('password')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="field">
                                    <a class="forgot" href="/forget">Forgotten Password?</a>
                                </div>
