                    ...
                    <div class="white_shd full margin_bottom_30">
                        <div class="full graph_head">
                            <div class="heading1 margin_0">
                                <a type="button" href="/admin/brands/create" class="btn btn-primary m-2 link-btn">Add
                                    New</a>
                            </div>
                        </div>
                        <div class="table_section padding_infor_info">
                            <div class="table-responsive-sm">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse($paginatedData as $brand)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>
                                                    <img style="width: 50pz; height: 50px;"
                                                        src="{{ $brand->brand_image
                                                            ? asset('Brand/' . $brand->brand_image)
                                                ...
                                                <td>
                                                    <a href="{{ url('/admin/brands/' . $brand->brand_id . '/edit') }}"
                                                        class="btn btn-warning text-dark">
                                                        Edit
                                                    </a>
                                                    <form action="{{ url('/admin/brands/' . $brand->brand_id) }}"
